...
public class OrderSummaryActivityTest {
    ...
    private static final String STATIC_CONTENT = "I just ordered a delicious tea from TeaTime. Next time you are craving a tea, check them out!";
    ...
    public void clickSendEmailButton_SendsEmail() {
        ...
        intended(allOf(
                ...
                hasExtra(Intent.EXTRA_TEXT, STATIC_CONTENT)
        ));
    }
}